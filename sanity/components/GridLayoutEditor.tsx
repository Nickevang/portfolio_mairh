import {type ArrayOfObjectsInputProps, set, useFormValue, useClient} from 'sanity'
...
export function GridLayoutEditor(props: ArrayOfObjectsInputProps) {
  const {value, onChange, renderDefault} = props
  const layout = useFormValue(['galleryLayout']) as string | undefined
  ...
  if (layout !== 'custom') {
    return renderDefault(props as Parameters<typeof renderDefault>[0])
  }

  function thumbUrl(item: GalleryImage): string | null {
